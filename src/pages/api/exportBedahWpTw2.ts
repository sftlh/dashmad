import { firstDateOfTheYear, quarterOne, quarterTwo, todayYear } from "@/lib/getaction";
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    worksheet2.getCell("A3").value = `TRIWULAN II ${todayYear}`;
    ...
    worksheet.getCell("A3").value = `TRIWULAN II ${todayYear}`;
    ...
    res.setHeader(
      "Content-Disposition",
      `attachment; filename=bedahwptw2_${todayYear}.xlsx`
    );
