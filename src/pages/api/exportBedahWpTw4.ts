import { firstDateOfTheYear, quarterFour, quarterOne, quarterThree, quarterTwo, todayYear } from "@/lib/getaction";
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    worksheet.getCell("A3").value = `Triwulan IV ${todayYear}`;
    ...
    res.setHeader(
      "Content-Disposition",
      `attachment; filename=bedahwptw4_${todayYear}.xlsx`
    );
