...
const FormKirimEmpoweringWajibPajakTw4 = () => {
    const {
        register,
        handleSubmit,
        formState: { errors },
      ...
      const onSubmit = handleSubmit(async (data: SendingDataToKanwil) => {
        try {
          const response = await fetch("/api/kirimKanwilEmpoweringWpTw4", {
            method: "POST",
            headers: {
          ...
          <form onSubmit={onSubmit}>
            <div className="border-b border-white/10 pb-12 items-center">
              ...
              <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <InputField hidden register={register} name='id' defaultValue={"empoweringtw4"}/>
              </div>
            </div>
...
export default FormKirimEmpoweringWajibPajakTw4
