...
const StepCabangPusatBedaEntitasForm3: React.FC<Step2Props> = ({
  nextStep,
  data,
  prevStep,
}) => {
          ...
          <h2 className="text-sm font-semibold mt-5">
            <div>
              <span className="text-pretty text-slate-700">
                Apakah Benar nomor NIK{" "}
              </span>
              <span className="text-dongker">{data.nikBersihCabang} </span>
              <span className="text-pretty text-slate-700">Wajib Pajak </span>
              <span className="text-dongker">{data.namaCabang}</span>{" "}
            </div>
            <div className="mt-2">
              <span className="text-pretty text-slate-700">
                Memiliki hubungan dengan NIK{" "}
              </span>
              <span className="text-red-500">{data.nikBersihPusat}</span>{" "}
              <span className="text-pretty text-slate-700">milik </span>
              <span className="text-red-500">{data.namaPusat}</span>{" "}
              <span className="text-pretty text-slate-700">? </span>
            </div>
          </h2>
          <select
            id="nikCabangPusatQuestion"
            {...register("nikCabangPusatQuestion")}
...
export default StepCabangPusatBedaEntitasForm3;
