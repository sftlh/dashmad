...
import { quarterOne, quarterThree, quarterTwo, today } from "@/lib/getaction";
import BoxOfStatusBedahWp from "./BoxOfStatusBedahWp";

const StatusEmpowering = ({ id, status }: { id: any; status: any[] }) => {
...
export default StatusEmpowering;
