...
export const quarterOneLess = new Date(todayYear, 3, 9);
export const quarterTwo = new Date(todayYear, 6, 10);
export const quarterTwoLess = new Date(todayYear, 6, 9);
export const quarterThree = new Date(todayYear, 9, 10);
export const quarterThreeLess = new Date(todayYear, 9, 9);
export const quarterFour = new Date(todayYear, 11, 10);
export const quarterFourLess = new Date(todayYear, 11, 9);
