...
COPY public."BedahWPData" (id, "npwpId", klasifikasi, "tahunPajak", pph21, pph22, pph23, pph2529, pph26, "pphFinal", pph15, ppn, "pajakLainnya", "createdAt", "userId", "pelaksanaanKegiatan", kunci, "sendingDataToKanwilId", "pdfFile") FROM stdin;
1	060324688615000	1	2022	\N	\N	\N	2039747612	\N	\N	\N	\N	\N	2025-03-18 01:40:34.462	user_2smaTpzecsrBC8bCeslF7ApFR6j	2025-01-14 00:00:00	f	\N	/uploads/1742262034446-Hasil Rapat Pembahasan DSPP Wajib Pajak an Heng Hok Soei Shindo Sumidomo Tahun Pajak 2022.pdf
\.
...
SELECT pg_catalog.setval('public."BedahWPData_id_seq"', 1, true);
